...
export function AdminFeatures() {
  const t = useTranslations("features.admin");
  ...
  return (
    <section className="bg-[#F5F5F4] px-6 py-20 lg:px-12 lg:py-24" aria-labelledby="admin-heading">
      <div className="mx-auto max-w-7xl">
        <p className="text-overline mb-4 font-bold uppercase tracking-[0.2em] text-[#F59E0B]">
          Admin
        </p>
        <h2 id="admin-heading" className="text-h2 text-[#111]">
          {t("title")}
        </h2>
